...
const styles = StyleSheet.create({
  ...
  title: { color: '#0B2347', fontSize: 20, lineHeight: 25, fontWeight: '700', letterSpacing: -0.4 },
  ...
  actionWarm: { backgroundColor: '#FFBF65' }, action: { color: '#0B2347', fontSize: 11, fontWeight: '600' },
  illustration: { width: '32%', maxWidth: 160, alignItems: 'center', gap: 10 },
  brand: { color: '#526176', fontSize: 9, fontWeight: '700', letterSpacing: 1.5 },
});
