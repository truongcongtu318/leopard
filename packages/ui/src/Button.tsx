...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary:
    "bg-neutral-surface text-neutral-text border border-neutral-border hover:bg-gray-200 focus-visible:ring-2 focus-visible:ring-neutral-border focus-visible:ring-offset-2",
  destructive:
  ...
  (
    ...
    return (
      <button
        ...
        onClick={handleClick}
        className={cn(
          "inline-flex items-center justify-center gap-xs rounded-control font-medium transition-colors focus-visible:outline-none disabled:opacity-50 disabled:cursor-not-allowed",
